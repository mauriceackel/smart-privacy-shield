...
set(GRESOURCE_C sps.gresource.c) # GResource compiled output file name
set(GRESOURCE_XML sps.gresource.xml) # GResource config input file name
...
configure_file(${CMAKE_CURRENT_SOURCE_DIR}/gui/${GRESOURCE_XML}.in ${GRESOURCE_XML} @ONLY)
...
message(${CMAKE_CURRENT_BINARY_DIR}/${GRESOURCE_C})
